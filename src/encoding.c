...
struct wildcard encoding_nuWildcards[encoding_nuNumCodes] = {
	{'A', (unsigned char *)"A", NULL, 1},
	{'C', (unsigned char *)"C", NULL, 1},
	{'G', (unsigned char *)"G", NULL, 1},
	{'T', (unsigned char *)"T", NULL, 1},
	{'N', (unsigned char *)"ACGT", NULL, 4},
	{'B', (unsigned char *)"CGT", NULL, 3},
	{'D', (unsigned char *)"AGT", NULL, 3},
	{'H', (unsigned char *)"ACT", NULL, 3},
	{'K', (unsigned char *)"GT", NULL, 2},
	{'M', (unsigned char *)"AC", NULL, 2},
	{'R', (unsigned char *)"AG", NULL, 2},
	{'S', (unsigned char *)"CG", NULL, 2},
	{'V', (unsigned char *)"ACG", NULL, 3},
	{'W', (unsigned char *)"AT", NULL, 2},
	{'Y', (unsigned char *)"CT", NULL, 2},
	{'!', (unsigned char *)"", NULL, 0}
};
struct wildcard encoding_aaWildcards[encoding_aaNumCodes] = {
	{'L', (unsigned char *)"L", NULL, 1},
	{'A', (unsigned char *)"A", NULL, 1},
	{'G', (unsigned char *)"G", NULL, 1},
	{'S', (unsigned char *)"S", NULL, 1},
	{'V', (unsigned char *)"V", NULL, 1},
	{'E', (unsigned char *)"E", NULL, 1},
	{'T', (unsigned char *)"T", NULL, 1},
	{'K', (unsigned char *)"K", NULL, 1},
	{'D', (unsigned char *)"D", NULL, 1},
	{'P', (unsigned char *)"P", NULL, 1},
	{'I', (unsigned char *)"I", NULL, 1},
	{'R', (unsigned char *)"R", NULL, 1},
	{'N', (unsigned char *)"N", NULL, 1},
	{'Q', (unsigned char *)"Q", NULL, 1},
	{'F', (unsigned char *)"F", NULL, 1},
	{'Y', (unsigned char *)"Y", NULL, 1},
	{'M', (unsigned char *)"M", NULL, 1},
	{'H', (unsigned char *)"H", NULL, 1},
	{'C', (unsigned char *)"C", NULL, 1},
	{'W', (unsigned char *)"W", NULL, 1},
	{'B', (unsigned char *)"ND", NULL, 2},
	{'Z', (unsigned char *)"QE", NULL, 2},
	{'X', (unsigned char *)"LAGSVETKDPIRNQFYMHCW", NULL, 20},
	{'U', (unsigned char *)"LAGSVETKDPIRNQFYMHCW", NULL, 20},
	{'!', (unsigned char *)"", NULL, 0}
};
...
void encoding_initialize(unsigned char alphabetType)
{
	...
	while (code < encoding_numLetters) {
		...
		encoding_wildcards[code].replacementCodes = (unsigned char*)global_malloc(sizeof(unsigned char) *
...
void encoding_encodeSequence(char* sequence, int4 sequenceSize, uint4 alphabetType)
{
	...
	idx = 0;
	while (idx < sequenceSize) {
		code = encoding_codesArray[(unsigned char)(sequence[idx])];
		sequence[idx] = code;
		idx++;
	}
}
