...
uint4 postings_hash32bit(unsigned char *sequence, uint4 sequenceLength, uint4 tableSize, uint4 seed);
// 64-bit hashing function
uint8 postings_hash64bit(unsigned char *sequence, uint4 sequenceLength, uint4 seed);
