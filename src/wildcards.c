...
struct clusterWildcard wildcards_clusterWildcards[wildcards_numClusterWildcards] = {
	{(unsigned char *)"LVIFM", 82961, {3, -1, -3, -2, 3, -2, -1, -2, -3, -2, 3, -2, -3, -1, 2, 0, 4, -2, -1, -1, -3, -2, -1, -4}, -0.443727},
	{(unsigned char *)"GEKRQH", 141476, {-2, -1, 1, 0, -2, 3, -1, 4, 0, -1, -3, 3, 0, 3, -3, -1, -1, 3, -3, -2, 0, 2, -1, -4}, -0.069308},
	{(unsigned char *)"AVTIX", 4195410, {1, 2, -1, 0, 3, -1, 3, -1, -2, -1, 3, -2, -2, -1, -1, -1, 0, -2, -1, -3, -2, -1, -1, -4}, -0.062484},
	{(unsigned char *)"SETKDN", 4584, {-2, 0, 0, 2, -2, 2, 2, 2, 4, -1, -2, 0, 4, 1, -3, -2, -1, 0, -2, -3, 3, 1, -1, -4}, 0.170094},
	{(unsigned char *)"LVTPRFYMHCW", 1034833, {1, -1, -2, -1, 1, -1, 1, -1, -2, 2, 0, 1, -1, 0, 2, 3, 2, 2, 2, 3, -2, -1, -1, -4}, 0.233131},
	{(unsigned char *)"AGSDPH", 131854, {-2, 3, 3, 3, -1, 0, 0, 0, 2, 2, -2, -1, 1, 0, -2, -2, -1, 1, -1, -3, 1, 0, 0, -4}, 0.311481},
	{(unsigned char *)"LAGSVETKDPIRNQFYMHCWBZXU", 16777215, {1, 1, 1, 2, 1, 2, 1, 1, 1, 1, 1, 1, 2, 2, 1, 1, 1, 2, 1, 1, 1, 1, -1, -3}, 1.267173},
};
...
void wildcards_readWildcards(char* filename)
{
	...
	letters = (unsigned char*)global_malloc(encoding_aaStartWildcards + 1);
	...
	while (count < wildcards_numClusterWildcards) {
		...
		while (code < encoding_aaStartWildcards) {
			fscanf(file, "%hd", &(wildcards_clusterWildcards[count].scoreMatrixRow[code]));
			code++;
