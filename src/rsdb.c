...
void rsdb_writeClusters(char* filename, struct sequence* sequences)
{
	...
	printf("Writing representative sequences to disk...");
	fflush(stdout);
...
//    hashCounter = rsdb_winnowingSpex(sequences, numberOfSequences, numberOfLetters);
	...
	printf("Identifying high-scoring sequence pairs / hierarchical clustering...");
	fflush(stdout);
	time = -clock();
